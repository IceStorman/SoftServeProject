...
from api.routes.scripts import make_cache_key
session = SessionLocal()
news_app = Blueprint('news', __name__)

'''To remember how to do it'''
#@news_app.errorhandler(SportNotFoundError)
#def handle_sport_not_found(error):
#    response = {"error-flask": error.message}
