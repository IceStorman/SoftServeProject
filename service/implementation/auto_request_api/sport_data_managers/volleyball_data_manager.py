...
class VolleyballDataManager(AbstractSportDataManager):
    def __init__(self, new_api_data: Dict[str, str]):
        super().__init__(new_api_data)
        self._sport_name = "volleyball"
        self._host = "v1.volleyball.api-sports.io"

    def get_teams_statistics(self) -> Dict[str, str]:
        url = f"https://v1.volleyball.api-sports.io/teams/statistics?season=2024&team={self._team_id}&league={self._league_id}"
